    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <input type="text" class="fi-input" placeholder="ອາຊີບລູກຄ້າ" v-model="customer_info['occupation']" required>
...
export default {
  ...
  methods: {
      ...
      doNext(){
          ...
          if(this.validateType() && this.validateName()  && this.validateAccounts()  && this.validateTel()){
                for(var i=0; i < this.customer_info['bank_accounts'].length; i++){
