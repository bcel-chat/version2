<template>
    <div class="container">
        <div v-if="showPersonalConfirm">
            ...
            <div class="fi-signature-dialog" :class="useSignature?'fi-choose-signature':'fi-choose-photo'">
                ...
                <div class="fi-take-photo" v-if="usePhoto">
                    ...
                    <div class="fi-take-photo-footer"  v-if="!checkPhotoError">
                        <button type="button" class="fi-btn-take-photo-cancel" @click="cancelTakePhoto()">ຍົກເລີກ</button>
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <h6><strong> ອັດຕາດອກເບ້ຍຍືດຫຍຸ່ນ</strong></h6> </td>
                                    </tr>
                                    <tr>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12" v-if="toggleMaxFlexible">
                            ...
                            <strong class="title">ອັດຕາດອກເບ້ຍຍືດຫຍຸ່ນສູງສຸດ</strong>
                            <span class="arrow1">&#8250;</span>
                            <span class="arrow2">&#8250;</span>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <strong class="title">ອັດຕາດອກເບ້ຍຍືດຫຍຸ່ນ(%) *</strong>
                        <span class="arrow1">&#8250;</span>
                        <span class="arrow2">&#8250;</span>
                        <input type="number" min="0" class="fi-input" placeholder="ດອກເບ້ຍຍືດຫຍຸ່ນ" v-model="customer_info['customer_interest']" required @keyup="validateCustomerInterest()" step="0.01">
                        <div class="fi-exceeded text-right" v-if="toggleMaxFlexible">
                            <span class="danger" v-if="getExceededOutFlexible()">(ຍືດຫຍຸ່ນເກີນ​ {{getExceededOutFlexible()}}%)</span>
                            <span class="success" v-if="getExceededInFlexible()">(ຍືດຫຍຸ່ນໃນກອບ {{getExceededInFlexible()}}%)</span>
                        </div>
...
.fi-signature-header, .fi-signature-body, .fi-take-photo-header,  .fi-take-photo-body{
    text-align: left;
}
.fi-take-photo-body{
    position: relative;
...
.fi-signature-footer, .fi-take-photo-footer{
    text-align: right;
}
.fi-btn-signature-ok, .fi-btn-take-photo-ok{
    margin-left: 5px;
    background: #20A816;
    color: white;
    border: none;
...
.fi-btn-signature-clear, .fi-btn-take-photo-clear{
    margin-left: 5px;
...
.fi-btn-signature-cancel, .fi-btn-take-photo-cancel{
    margin-left: 5px;
    background: #EE3024;
    color: white;
    border: none;
...
.fi-btn-choose-signature, .fi-btn-choose-photo{
    margin-top: 5px;
    margin-bottom: 10px;
    background: #C72B2C;
    color: white;
