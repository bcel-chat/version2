            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-4" v-for="(history, index) in customer_requirement_history" :key="index">
                <div class="fi-card text-left">
                    <div class="fi-card-title">
                        ...
                        <small>: {{history['userStepper']}}</small>
                    </div>
...
export default {
  ...
  methods: {
    ...
    doLoadMoreItem(){
        ...
        if(this.search_data.trim()) {
           this.getAllNewApproveRequestSearchLoadMore();
        } else {
            this.getAllNewApproveRequestLoadMore();
        }
    },
    doSearch(){
       if(this.search_data.trim()) {
    ...
    getAllNewApproveRequestSearchLoadMore(){
        ds.rpc.make('/bcel/api/flexible/interest/leader/request/approve/new/search', { 
    ...
    getAllNewApproveRequestLoadMore(){
        ds.rpc.make('/bcel/api/flexible/interest/leader/request/approve/new', { 
            user:  this.$store.getters['flexible_interest_module/user'], 
            rowIndex: this.customer_requirement_history.length
        }, ( error, result ) => {
            if(result){
