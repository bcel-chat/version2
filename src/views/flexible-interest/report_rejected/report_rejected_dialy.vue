      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-12">
          <h3 class="fi-title text-center">
            <strong>ລາຍການທີ່ຖືກປະຕິເສດປະຈຳວັນ</strong>
          </h3>
        </div>
        <div class="col-12 col-sm-12 col-md-12">
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      ds.rpc.make(
        "/bcel/chat/api/flexible/interest/report/customer/requirement/rejected/dialy",
        {
          limited: this.limit,
      ...
      if (this.customer_requirments.length > 0) {
        import("@/vendor/Export2Excel").then(excel => {
          ...
          excel.export_json_to_excel({
            ...
            data,
            filename:
              "report-interest-flexible-rejected-dialy-" +
