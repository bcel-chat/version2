            ...
            <ul id="interest" class="text-left fi-dropdown">
              <li v-for="(user, index) in recieveUserList" :key="index">
                <label class="fi-checkbox-container">
                  <span>
                    {{user['fullName']}}
                    <span v-if="user['positionLevel'] == 1">({{user['positionId']}})</span>
                  </span>
    ...
    <div class="row hide-on-print-mode">
      <div class="col-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="text-left fi-status">
          <h3>
            <strong>ສະຖານະອະນຸມັດ:</strong>
            <strong
              :class="(customer_info['approveStatus'] == 'REJECTED_50')?'REJECTED':customer_info['approveStatus']"
            >{{(customer_info['approveStatus'] == 'REJECTED_50')?'REJECTED':customer_info['approveStatus']}}</strong>
          </h3>
          <span
            v-if="(customer_info['approveStatus'] == 'APPROVED') || (customer_info['approveStatus'] == 'SUCCESS') || (customer_info['approveStatus'] == 'REJECTED') || (customer_info['approveStatus'] == 'REJECTED_50')"
            :class="(customer_info['approveStatus'] == 'REJECTED_50')?'REJECTED':customer_info['approveStatus']"
          >ໂດຍ: {{customer_info['approveUserName']}}</span>
          <span
            v-else-if="(customer_info['approveStatus'] == 'CANCEL')"
            :class="customer_info['approveStatus']"
          >ໂດຍ: {{customer_info['createUserName']}}</span>
        </div>
      </div>
          ...
          <div>
            <div class="row">
              ...
              <div
                ...
                :class="customer_info['photo']?'col-lg-9':'col-lg-12'"
              >
                <table style="width: 100%">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        {{customer_info['customerName']?customer_info['customerName']:'................'}}
                        <span>({{customer_info['customerTypeDesc']}})</span>
                      </td>
                    </tr>
                    <tr>
            ...
            <table style="width: 100%">
              <tbody>
                ...
                <tr>
                  ...
                  <td
                    v-if="customer_info['currencyName']"
                  >{{customer_info['currencyName']}} ({{customer_info['currencyCode']}})</td>
                  <td v-else>................</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>{{customer_info['normalInterest']?customer_info['normalInterest']:'0'}}%</td>
                </tr>
                <tr>
                  <th class="fi-title">ດອກເບ້ຍທີ່ລູກຄ້າຈະໄດ້ຮັບ/ປີ:</th>
                  <td>{{(customer_info['currencyCode'] == 'USD')?customer_info['currencyUnit']:''}}{{getEarningPerYear('normalInterest')}}{{(customer_info['currencyCode'] != 'USD')?customer_info['currencyUnit']:''}}</td>
                </tr>
                <tr>
                  <th class="fi-title">ດອກເບ້ຍຍືດຫຍຸ່ນສູງສຸດ:</th>
                  <td>{{customer_info['interestFlexible']?customer_info['interestFlexible']:'0'}}%</td>
                </tr>
                <tr>
                  ...
                  <td>
                    ...
                    >
                      ...
                      <span
                        v-if="(customer_info['approveStatus'] == 'APPROVED') || (customer_info['approveStatus'] == 'SUCCESS')"
                      >
                        <strong
                          v-if="(customer_info['approveInterest'] == customer_info['customerInterest'])"
                          class="APPROVED"
                        >&#10003;</strong>
                      </span>
                    </span>
                ...
                <tr>
                  ...
                  <td>{{(customer_info['currencyCode'] == 'USD')?customer_info['currencyUnit']:''}}{{getEarningPerYear('customerInterest')}}{{(customer_info['currencyCode'] != 'USD')?customer_info['currencyUnit']:''}}</td>
                </tr>
                <tr style="background: yellow;" v-if="customer_info['bankInterest']">
                  <th
                    class="fi-title"
                    v-if="(customer_info['bankInterest'] != customer_info['customerInterest'])"
                  >ດອກເບ້ຍທີ່ ທຄຕລ ໃຫ້ໄດ້:</th>
                  <td v-if="(customer_info['bankInterest'] != customer_info['customerInterest'])">
                    {{customer_info['bankInterest']}}%
                    <span
                      style="color: red;"
                      v-if="getExceededOutFlexibleBank() "
                    >
                      (ຍືດຫຍຸ່ນເກີນ {{getExceededOutFlexibleBank()}}%)
                      <span
                        v-if="(customer_info['approveStatus'] == 'APPROVED') || (customer_info['approveStatus'] == 'SUCCESS') || (customer_info['approveStatus'] == 'CANCEL')"
                      >
                        <strong
                          v-if="(customer_info['approveInterest'] == customer_info['bankInterest'])"
                          class="APPROVED"
                        >&#10003;</strong>
                      </span>
                    </span>
                ...
                <tr style="background: yellow;" v-if="customer_info['bankInterest']">
                  <th
                    class="fi-title"
                    v-if="(customer_info['bankInterest'] != customer_info['customerInterest'])"
                  >ດອກເບ້ຍທີ່ລູກຄ້າຈະໄດ້ຮັບ:</th>
                  <td
                    v-if="(customer_info['bankInterest'] != customer_info['customerInterest'])"
                  >{{(customer_info['currencyCode'] == 'USD')?customer_info['currencyUnit']:''}}{{getEarningPerYear('bankInterest')}}{{(customer_info['currencyCode'] != 'USD')?customer_info['currencyUnit']:''}}</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div>
            <div class="row">
              <div class="col-12">
                ...
                <span
                  class="fi-text"
                >{{customer_info['staffNote']?customer_info['staffNote']:'........................................................'}}</span>
              </div>
              <div class="col-12">
            ...
            <div class="fi-account" v-for="(product, index) in products" :key="index">
              <div class="fi-account-detail text-left">
                ...
                <h4 class="fi-account-title">
                  ...
                  ></label>
                  ເລກບັນຊີ:
                  <strong>{{product['accountNo']}}</strong>
                </h4>
        ...
        this.fi_config = {
          ...
          buttons: [
            ...
            },
            {
              ...
              action: () => {
                this.fi_config["show"] = false;
                var comment = this.$store.getters[
                  "flexible_interest_module/commentRequest"
                ];
                var _status = this.$store.getters[
                  "flexible_interest_module/commentRequestStatus"
                ];
                var bankInterest = this.$store.getters[
                  "flexible_interest_module/bankInterest"
                ];

                this.$store.commit(
                  "flexible_interest_module/changeCommentRequest",
                  { comment: "" }
                );
                this.$store.commit(
                  "flexible_interest_module/changeCommentRequestStatus",
                  { status: "" }
                );
                this.$store.commit(
                  "flexible_interest_module/changeBankInterest",
                  { interest: "" }
                );
                //console.log(bankInterest)
                this.checkSaveLoading = true;
                ds.rpc.make(
                  "/bcel/chat/api/flexible/send/approve/manually",
                  {
    ...
    getProducts() {
      if (this.customer_info["bankAccounts"].length > 0) {
        axios
          .post(
            address["serverIp"] +
              "/bcel/api/flexible/interest/products/history/html",
          ...
          .then(res => {
            ...
            for (var j = 0; j < products.length; j++) {
              ...
              var productArr = products[j]["list_html"].match(
                /<div class='product.*<\/h2>/g
              );
              var productUsage = "";
              for (var k = 0; k < productArr.length; k++) {
                if (productArr[k].search("disabled") < 0) {
                  var product =
                    productArr[k]
                      .split("h2")[1]
                      .slice(1, productArr[k].split("h2")[1].length - 2) + ", ";
                  productUsage += product;
                }
              }
              products[j]["list"] = productUsage
                .trim()
                .slice(0, productUsage.length - 2);
              try {
            ...
            buttons: [
              ...
              },
              {
                ...
                action: () => {
                  this.fi_config["show"] = false;
                  var comment = this.$store.getters[
                    "flexible_interest_module/commentEdit"
                  ];
                  this.$store.commit(
                    "flexible_interest_module/changeCommentEdit",
                    { comment: "" }
                  );
                  this.checkSaveLoading = true;
                  ds.rpc.make(
                    "/bcel/chat/api/flexible/interest/create/response/edit/notification",
                    {
            ...
            buttons: [
              ...
              },
              {
                ...
                action: () => {
                  this.fi_config["show"] = false;
                  var comment = this.$store.getters[
                    "flexible_interest_module/commentApprove"
                  ];
                  var approve_interest = this.$store.getters[
                    "flexible_interest_module/bankInterest"
                  ];
                  //console.log(approve_interest)
                  this.$store.commit(
                    "flexible_interest_module/changeCommentApprove",
                    { comment: "" }
                  );
                  this.$store.commit(
                    "flexible_interest_module/changeBankInterest",
                  ...
                  this.checkSaveLoading = true;
                  ds.rpc.make(
                    "/bcel/chat/api/flexible/interest/approve/customer/requirement",
                    {
                      user: this.$store.getters[
                        "flexible_interest_module/user"
                      ],
            ...
            buttons: [
              ...
              },
              {
                ...
                action: () => {
                  ...
                  this.checkSaveLoading = true;
                  ds.rpc.make(
                    "/bcel/chat/api/flexible/interest/reject/customer/requirement",
                    {
                      user: this.$store.getters[
                        "flexible_interest_module/user"
                      ],
