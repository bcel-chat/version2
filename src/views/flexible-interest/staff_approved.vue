<template>
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      >
        <div
          class="fi-card text-left"
          :class="(history['approveStatus'] == 'APPROVED')?'approved':(history['approveStatus'] == 'SUCCESS')?'success':'cancel'"
          ...
          <div class="fi-card-title">
            ...
            <span class="fi-top-right-action" v-if="(history['approveStatus'] == 'APPROVED')">
              <span
                ...
                class="confirmIcon"
                @click="confirmAccountCreated(history, index)"
              >
              ...
              <span
                title="ຍົກເລີກລາຍການ"
                class="closeIcon"
                v-if="(history['approveStatus'] != 'CANCEL')"
...
export default {
  ...
  methods: {
    ...
    getAllApprovedSearch() {
      ds.rpc.make(
        "/bcel/api/flexible/interest/customer/requirement/by/staff/approved/search",
        {
    ...
    getAllApproved() {
      ds.rpc.make(
        "/bcel/api/flexible/interest/customer/requirement/by/staff/approved",
        {
          staffUser: this.$store.getters["flexible_interest_module/user"]
        },
        (error, result) => {
        ...
        buttons: [
          ...
          },
          {
            ...
            action: () => {
              this.fi_config["show"] = false;
              ds.rpc.make(
                "/bcel/chat/api/flexible/interest/confirm/customer/requirement/approved/account/created",
                {
                      ...
                      buttons: [
                        {
                          ...
                          action: () => {
                            if (result["success"]) {
                              this.customer_requirement_history[index][
                                "approveStatus"
                              ] = "SUCCESS";
                            }
                            this.fi_config["show"] = false;
    ...
    sendCancelApproved() {
      if (this.comment.trim()) {
        this.message = "";
        ds.rpc.make(
          "/bcel/chat/api/flexible/interest/customer/requirement/approved/cancel",
          {
            requirementId: this.chosenCancelRequirement["history"][
              "requirementId"
            ],
                    ...
                    action: () => {
                      if (result["success"]) {
                        this.customer_requirement_history[
                          this.chosenCancelRequirement["index"]
