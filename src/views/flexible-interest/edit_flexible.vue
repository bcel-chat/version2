                ...
                <div class="fi-card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                            ...
                            <span style="color: red; font-size: 12px;" v-if="getExceededOutFlexible()"> (ຍືດຫຍຸ່ນເກີນ​ {{getExceededOutFlexible()}}%)</span>
                            <span style="color: #20A816; font-size: 12px;" v-if="getExceededInFlexible()"> (ຍືດຫຍຸ່ນໃນກອບ​ {{getExceededInFlexible()}}%)</span>
                        </div>
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <ul class="fi-text">
                                    ...
                                    <li v-for="(file, index) in document_files" :key="index"><a :href="fileIp + file['docUrl']" target="_blank" rel="noopener noreferrer">{{file['docName']}} </a> <span class="closeIcon" @click="deleleFile(index, file)"> x</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
