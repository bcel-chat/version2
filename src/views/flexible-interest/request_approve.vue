        ...
        <div class="row hide-on-print-mode">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 text-left">
                <div class="fi-card">
                    ...
                    <div class="fi-box">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-3" v-if="customer_info['customer_photo']">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span style="color: red;" v-if="getExceededOutFlexible()"> (ຍືດຫຍຸ່ນເກີນ​​ {{getExceededOutFlexible()}}%)</span>
                                                <span style="color: #20A816;" v-if="getExceededInFlexible()"> (ຍືດຫຍຸ່ນໃນກອບ​ {{getExceededInFlexible()}}%)</span>
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="col-12">
                                ...
                                <div>
                                    ...
                                    <ul style="margin-top: 10px;" class="fi-text">
                                        ...
                                        <li v-for="(file, index) in customer_info['document_files']" :key="index">{{file['name']}} &nbsp <i class="fa fa-times closeIcon" @click="removeFile(index)"></i> </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
      ...
      getDocumentFiles($event){
          ...
          for(var i = 0; i < files.length; i++){
            ...
            for(var j = 0; j < this.customer_info['document_files'].length; j++){
              if(this.customer_info['document_files'][j]['name'] == files[i]['name']) {
                exist += 1;
                break;
              }
            }
