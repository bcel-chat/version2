    ...
    actions: {
        ...
        setRoom(context, payload) {
            ...
            ds.rpc.make("setRoom", {
                ...
                if (!err)
                    context.dispatch("getUserRoom", payload)
                else
                    console.log(data);
            })
        },
        ...
        getParticipantRoom({
            ...
            ds.rpc.make("getParticipantRoom", payload, (err, data) => {
                if (!err)
                    commit("getParticipantRoom", data[0])
                else
                    console.log(data);
            })
        },
        ...
        getParticipantInfo({
            ...
            ds.rpc.make("getParticipantInfo", {
                rid: state.participantRoom.rid,
            }, (err, data) => {
                if (!err)
                    commit("getParticipantInfo", data);
            })
        },
        addParticipant({
            state
